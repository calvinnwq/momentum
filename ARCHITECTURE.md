...
`src/core/workflow/`; ARCH-04 has populated `src/core/executors/`. Detailed placement, type, docs, test, and remaining rules live in
[internal/contracts/repo-architecture-standard.md](internal/contracts/repo-architecture-standard.md).
...
- Core modules, including `src/core/workflow/` and `src/core/executors/`, must not import command or renderer layers.

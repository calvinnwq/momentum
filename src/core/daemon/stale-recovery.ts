...
import { resolveGoalArtifactPaths } from "../evidence/artifacts.js";
...
} from "../goal/recovery-artifact.js";
 ...
 * `DEFAULT_DAEMON_ACTIVE_JOB_STALE_AFTER_MS` in `config/daemon-defaults` so the startup

...
import { resolveRecoveryArtifactPath } from "../goal/recovery-artifact.js";
import {
  listStaleRepoLocks,
  type RepoLockRow,
  type RepoLockState
 ...
 * observed `now` so callers (daemon status, doctor) see a coherent view of
 * orphaned repo locks and stale claimed/running `goal_iteration` jobs.
 *

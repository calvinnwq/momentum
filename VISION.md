...
Result documents, verification, and commit-or-reset boundaries are narrower mechanism contracts for agent, script, and binding-backed handoff work rather than requirements imposed on every external-state read.

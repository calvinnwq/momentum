...
The historical `gnhf` and `native-goal-loop` labels do not select those executors, and both executor paths resolve their machine-local mechanism from the step-kind live-wrapper binding.

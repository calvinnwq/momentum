...
NGX-278 introduced the M3 closeout marker on `doctor --json` / text. NGX-286 later flipped it to the M4 closeout marker, NGX-294 flipped it again to the M5 closeout marker, NGX-302 flipped it again to the M6 closeout marker, and NGX-319 (M7-07) flipped it forward to the M7 closeout marker.

...
Milestone 5 (Source Adapters and Evidence Sync) is the active milestone. M5 makes Momentum source-and-evidence aware while preserving the M4 runner contract and the M3 operational-safety surface. NGX-287, NGX-288, NGX-289, and NGX-290 are done; NGX-291 through NGX-294 remain. M5 is **not** complete and the `doctor --json` milestone string remains the M4 closeout marker until M5-07 (NGX-294) intentionally flips it as part of M5 closeout.

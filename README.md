...
```text
<data-dir>/
  momentum.db                  # SQLite (goals, jobs, events, repo_locks, daemon_runs, source_items, source_snapshots, source_reconciliation_runs, evidence_records tables)
  goals/
    <goal-id>/
...
Milestone 5 (Source Adapters and Evidence Sync) is the active milestone. M5 makes Momentum source-and-evidence aware while preserving the M4 runner contract and the M3 operational-safety surface. NGX-287, NGX-288, NGX-289, NGX-290, NGX-291, and NGX-292 are done; NGX-293 and NGX-294 remain. M5 is **not** complete and the `doctor --json` milestone string remains the M4 closeout marker until M5-07 (NGX-294) intentionally flips it as part of M5 closeout.
